...
import img4 from '../images/dealsfinder.png';
import img5 from '../images/larayamobile.png';
import img6 from '../images/bonsaimobile.png';

export const numbers = ['01', '02', '03', '04'];

export const titles = ['Web Scraper', 'Ecommerce Website', 'Drawing App', 'Landing Page', 'Landing Page'];

export const descriptions = [
'Web Scraper that allows users to find the best prices for: Real Estate, Cars, Clothes. Hosted on free server so it takes time to fetch data.',
...
export const github = [
'https://github.com/kevchong1126/dealsfinder',
'https://github.com/kevchong1126/laraya',
'https://github.com/kevchong1126/image-editor',
'https://github.com/kevchong1126/bonsai',
];

export const images = [img4, img1, img2, img3];

export const mobile = [false, img5, false , img6];

export const technologies = [
    ['REACT', 'EXPRESS', 'CHEERIO'],
